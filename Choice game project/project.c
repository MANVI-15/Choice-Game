...
void question1()
{
    char ch;
    FILE *ques1;
ques1= fopen("C:\\Users\\manvi\\Desktop\\C genie\\C genie\\question1.txt","r");
       int flag=0;
    for(int k=0;k<10;k++)
    {
        userinq1[k]='\0';
...
void superheroes(){
   char ch;
FILE *ques;
ques=fopen("C:\\Users\\manvi\\Desktop\\C genie\\C genie\\Superheroes.txt","r");
FILE *answ;
answ=fopen("C:\\Users\\manvi\\Desktop\\C genie\\C genie\\superheroans.txt","r");
...
char ch;
FILE *ques;
ques=fopen("C:\\Users\\manvi\\Desktop\\C genie\\C genie\\cricketersques.txt","r");
FILE *answ;
answ=fopen("C:\\Users\\manvi\\Desktop\\C genie\\C genie\\cricketersans.txt","r");
...
char ch;
FILE *ques;
ques=fopen("C:\\Users\\manvi\\Desktop\\C genie\\C genie\\cartoonques.txt","r");
FILE *answ;
answ=fopen("C:\\Users\\manvi\\Desktop\\C genie\\C genie\\cartoonans.txt","r");
...
void bollywood(){
   char ch;
FILE *ques;
ques=fopen("C:\\Users\\manvi\\Desktop\\C genie\\C genie\\actorques.txt","r");
FILE *answ;
answ=fopen("C:\\Users\\manvi\\Desktop\\C genie\\C genie\\actorans.txt","r");
...
void UI(){
    ...
    delay(300);
    logo(32,4);
  PlaySound(TEXT("C:\\Users\\manvi\\Desktop\\C genie\\C genie\\first.wav"),NULL,SND_SYNC);
    system("color 0C");
    delay(200);
...
void credits()
{
    ...
    gotoxy(44,8);
    Beep(5500,200);
    printf("* MANVI NEEKHRA 18103101");
    delay(200);
    gotoxy(44,9);
    Beep(5500,200);
    printf("* SHULIN PATHAK 18103114");
    delay(200);
    gotoxy(44,10);
    Beep(5500,200);
    printf("* SHREYA GROVER 18103113");
    delay(200);
    gotoxy(44,11);
    Beep(5500,200);
    printf("* NAVJOT SINGH  18103105");
    delay(200);
    system("color 0C");
    delay(300);
    system("color 0A");
